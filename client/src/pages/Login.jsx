...
const Login = () => {
  return (
    <section
      id="home-page"
      className="text-white min-h-screen px-6 pt-8 bg-[url('https://images.unsplash.com/photo-1610963862091-bafed38fb4fb?q=80&w=1632&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center relative"
    >
      <div className="absolute inset-0 bg-black opacity-75 z-10"></div>

      <div className="flex relative justify-center min-h-screen z-50">
